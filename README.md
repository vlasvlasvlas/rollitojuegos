...
6. **Aprobada o Eliminado:**
   ...
   - Si la deuda supera los -$1200.00, la máquina grita **SALDO INSUFICIENTE** con un arpegio menor descendente, el rostro se transforma en su versión **triste**, y el jugador "se baja del bondi" quedando eliminado.
7. **Transbordo por Eliminación:** Tras una eliminación, las puertas del bondi se cierran. **El juego pausa** mostrando el cartel `RECARGANDO SUBE` con un evento callejero aleatorio (`SUBE TIRADA EN EL PISO`, `KIOSCO DUDOSO`, `BILLETE EN EL BOLSILLO`, `LA SUBE DEL VIEJO`...) y queda esperando un toque para abrir el nuevo bondi. **Los saldos de todos los sobrevivientes se resortean** al transbordar, evitando que la partida sea predecible.
...
- **Reset de Economía por Nivel:** Al transbordar, los saldos ocultos de todos los sobrevivientes se reescriben con valores aleatorios nuevos. Narrativamente justificado por la recarga callejera, mecánicamente garantiza que la partida no sea predecible desde el primer toque.
